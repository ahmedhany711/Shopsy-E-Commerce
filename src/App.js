...
function App() {
  ...
  return (
    <div id='body' className="bg-white  dark:text-white duration-200 font-content text-gray-800 " >
      < NAV handleOrderPopup={handleOrderPopup} data={data} />
      {/* <SearchBar data={data} /> */}
      <Routes>
        <Route path="/" element={<Home />} />
        <Route path="checkout" element={<CheckoutPage />} />
        <Route path="/top-rated" element={<TopRatedProducts showButton={false} showFooter={true} inHome={false} />} />
        <Route path="/trending-products" element={< Products showButton={false} showFooter={true} showSlider={false} inHome={false} />} />
        <Route path="/best-selling" element={< TopSelling showButton={false} showFooter={true} inHome={false} />} />
