...
const SearchBar = ({ data }) => {
    ...
    return (
        <div className="flex justify-between items-center gap-5 text-gray-800  " ref={searchRef}>
            ...
            {/* Render search results only if there's a search query */}
            {searchQuery &&
                (
                    <div className=' m-0 p-0 '>
                        ...
                        <div className='w-screen h-screen bg-black/30 fixed top-0 left-0 backdrop-blur-sm z-10 '>
                            ...
                            <ul className='  fixed top-[56px] bg-white shadow-md left-[480px] w-[355px] z-[100] h-[300px] overflow-y-scroll  pt-4 px-0 text-gray-700 border-2  border-primary/100 ring-1 ring-primary/100 cursor-pointer'>
                                {/*  X Icon */}
                                ...
                                {filteredData.map(item => (
                                    <li key={item.id}
                                        className=' my-3 hover:bg-primary/20      '
                                    >
