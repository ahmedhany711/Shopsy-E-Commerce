...
import img1 from "../../../../photos/WomanPnner.jpg";
import img2 from "../../../../photos/woman22.jpg";
...
const Womans = () => {
  ...
  return (
    <>
      <div className=" mt-32 dark:mt-32  dark:bg-gray-900  h-[415vh] dark:h-[435vh] overflow-hidden">
        {/* Body  */}
        <div className="container pb-20">
          ...
          >
            ...
            <h1 className="text-3xl font-medium  absolute left-7 top-7 text-gray-700 dark:text-white">
              Woman's
          ...
          <div className="font-heading grid grid-cols-1 lg:grid-cols-2 py-10 gap-5">
            ...
            <div data-aos="zoom-in" className="relative w-full">
              ...
              />
              {/* Overlay */}
              <div className="absolute inset-0 bg-black/60 rounded-3xl w-full "></div>
              {/* Text */}
                      ...
                      <div className="mx-auto ">
                        ...
                        >
                          <img
                            ...
                            alt=""
                            className={`w-[220px] h-[270px]  bg-top  shadow-md  hover:scale-110  rounded-lg px-1 ${
                              data.image ? "object-contain" : "object-cover"
                            } `}
                          />
