...
import img1 from "../../../../photos/Jewelry/jew1.jpg";
import img2 from "../../../../photos/Jewelry/jew2.jpg";
...
const Jewelry = () => {
  ...
  return (
    <>
      <div className=" mt-32 dark:mt-32 dark:bg-gray-900 h-[180vh] dark:h-[200vh] overflow-hidden  ">
        {/* Body  */}
        <div className="container pb-20">
          ...
          >
            ...
            <h1 className="text-6xl font-medium  absolute left-16 top-4 text-gray-700 dark:text-white">
              {" "}
              Jewelry
            </h1>
          </div>
                      ...
                      <div className="mx-auto ">
                        ...
                        >
                          <img
                            ...
                            alt=""
                            className={`w-[220px] h-[250px]     shadow-md  hover:scale-110  rounded-lg p-1  `}
                          />
